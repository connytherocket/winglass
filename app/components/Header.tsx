...
import { Menu, Search, Phone, ChevronDown, MapPin, Wrench, Shield, Award, Info, PhoneCall, Star } from "lucide-react";
...
export function Header() {
  ...
  const locations = [
    { name: "Herrenberg", href: "/standorte/herrenberg" },
    { name: "Bietigheim-Bissingen", href: "/standorte/bietigheim-bissingen" },
  ];
      ...
      <div className="container mx-auto flex h-full items-center justify-between px-4">
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          >
            ...
            <div className={cn(
              "absolute left-1/2 -translate-x-1/2 top-full mt-6 w-[400px] rounded-xl shadow-2xl bg-background border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300",
              "before:absolute before:left-1/2 before:-translate-x-1/2 before:-top-2 before:border-8 before:border-transparent before:border-b-background"
            )}>
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {locations.map((location) => (
                    <Link
                      key={location.name}
                      to={location.href}
                      className="p-3 rounded-lg hover:bg-accent transition-colors text-sm font-medium"
                    >
                      {location.name}
                    </Link>
                  ))}
          ...
          {/* CTA Button */}
          <Button asChild size={isScrolled ? "default" : "lg"} className="transition-all">
